  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center pt-24 pb-16">
      <div className="text-center">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex rounded-lg bg-accent px-6 py-2.5 text-sm font-medium text-white no-underline transition-colors duration-normal hover:bg-accent-hover"
        >
          Back to Home
        </Link>
      </div>
